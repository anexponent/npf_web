...
Route::controller(igpsecController::class)->group(function () {
    Route::middleware(['auth', 'verified'])->group(function () {
        ...
        Route::get('/edit/igp', 'editIGP')->name('igpsec.index');
        Route::get('/edit/igpsec/{id}', 'editSec')->name('edit_igpsec');
...
Route::controller(forcestructureController::class)->group(function () {
    Route::middleware(['auth', 'verified'])->group(function () {
        ...
        Route::get('/edit/force', 'showForce')->name('force_show');
        Route::get('/edit/force/{id}', 'editForce')->name('edit_force');
        Route::post('/update/force{id}', 'updateFroce')->name('update.force');
    });
...
Route::controller(ServiceController::class)->group(function () {
    ...
    Route::get('/home/service/{id}', 'Homeservice')->name('service.home');
...
Route::controller(IgpSpeechController::class)->group(function(){
    ...
    Route::controller(peacekeepingController::class)->group(function () {
        Route::middleware(['auth', 'verified'])->group(function () {
            ...
            Route::post('/store/message', 'storePeace')->name('store.peace');
    ...
    Route::controller(fproController::class)->group(function () {
        Route::middleware(['auth', 'verified'])->group(function () {
            ...
            Route::post('/store/message', 'StoreFpro')->name('store.fpro');
