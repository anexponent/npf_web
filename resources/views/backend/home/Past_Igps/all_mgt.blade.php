                ...
                <section class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @php($i = 1)
                                @foreach($pstigpteam as $item)
                                <tr>
                                    <td> {{ $i++}} </td>
                                    <td> {{ $item->full_name }} </td>
                                    <td> {{ $item->duration_service }} </td>
                                    ...
                                    <td>
                                        <a href="{{route('edit.pastigp',$item->id)}}" class="btn btn-info sm"
                                            title="Edit Data"> <i class="fas fa-edit"></i> </a>

                                        <a href="{{route('delete.pastigp',$item->id)}}" class="btn btn-danger sm"
