            ...
            <div class="row">
                ...
                <section class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <form method="post" action="{{route('store.pastigp')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg"
                                        src="{{ (!empty($pstigpteam->team_image))? url( $pstigpteam->team_image):url('upload/no_image.png') }}"
                                        alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
