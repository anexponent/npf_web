            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('update.department')}}" method="post">
                        ...
                        <input type="hidden" name="dept_id" value="{{$dpo->id}}">
                        <div class="input-group mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Full name</label>
                        <input type="text" name="dig_name" class="form-control" required value="{{$dpo->dig_name}}" placeholder="Full name" >
                        ...
                        <input type="text" name="department"  class="form-control" required value="{{$dpo->department}}" placeholder="AP Number">
                        <div class="input-group-append">
                            <div class="input-group-text">
                            </div>
                        </div>
                        ...
                        <textarea name="description" cols="140" rows="10">{{$dpo->description}}</textarea>
                        <div class="input-group-append">
                            <div class="input-group-text">
                            </div>
                        </div>
