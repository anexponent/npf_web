        ...
        <div class="content-wrapper">
            ...
            <div class="mission">
                ...
                <div class="card-header">
                    <h4>Edit & Update IGPSEC 
                        <a href="{{ route('igpsec.index')}}" class="btn btn-danger float-end">BACK</a>
                    </h4>
                </div>
                <div class="card-body">

                    <form action="{{ route('update.igpsec',$igpsec->id) }}" method="POST">
                        @csrf
    

                        <div class="form-group mb-3">
                            <label for="">Title</label>
                            <input type="text" name="title" value="{{$igpsec->title}}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="">Message Body</label>
                         <textarea id="summernote" type="text"  class="form-control" name="message" rows="10">{{$igpsec->body}}"</textarea>
                        </div>
                        <div class="form-group mb-3">
