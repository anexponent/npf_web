            ...
            <div class="container-fluid">
                ...
                <!-- Left col -->
                    <section class="col-lg-12">
                        ...
                        <div class="card">
    <form method ="post" action="{{url('store.vision')}}" class="vision_form">
        @csrf
                        
  <div class="mb-3">
    <label for="title" class="form-label">Title</label>
    <input type="text" class="form-control" name="title" id="title" aria-describedby="titleHelp" placeholder="Vision and Mission Statement">
  </div>
  <div class="col-sm-10">
    <label for="message" class="form-label">Message body</label>
    <textarea id="summernote"  class="form-control" name="message" rows="5"></textarea>
  </div>
