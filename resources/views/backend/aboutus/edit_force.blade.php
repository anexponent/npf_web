        ...
        <div class="content-wrapper">
            ...
            <div class="mission">
                ...
                <div class="card-header">
                    <h4>Edit & Update Force Structure
                        <a href="{{ route('force_structure')}}" class="btn btn-danger float-end">BACK</a>
                    </h4>
                </div>
                <div class="card-body">

                    <form action="{{ route('update.force',$force->id) }}" method="POST">
                        @csrf
    

                        <div class="form-group mb-3">
                            <label for="">Title</label>
                            <input type="text" name="title" value="{{$force->title}}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="">Force Structure</label>
                         <textarea id="summernote" type="text"  class="form-control" name="body" rows="10">{{$force->body}}"</textarea>
                        </div>
                        <div class="form-group mb-3">
