        ...
        <div class="content-wrapper">
            ...
            <div class="mission">
                ...
                <div class="card-header">
                    <h4>Edit & Update History
                        <a href="{{ route('history.index')}}" class="btn btn-danger float-end">BACK</a>
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('update.history',$history->id) }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            <label for="">History of NPF</label>
                         <textarea id="summernote" type="text"  class="form-control" name="body" rows="10">{{$history->body}}</textarea>
                        </div>
                        <div class="form-group mb-3">
