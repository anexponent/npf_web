...
<div class="wrapper">
  ...
  <!-- End Main Sidebar  -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
    <form action ="{{route('store.fpro')}}" method="post" enctype="multipart/form-data">
    @csrf
...
<div class="mb-3">
    <label for="fornname" class="form-label">Upload Picture</label>
    <input type="file" class="form-control" name="image" id="name" aria-describedby="nameHelp">
</div>

      <div class="col-sm-10">
      <img  width="100"  id="showImage" src="{{url('upload/fpro/no_image.png')}}" class="rounded avatar-lg" alt="card image cap">
