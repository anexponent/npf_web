        ...
        <div class="content-wrapper">
            ...
            <div class="mission">
                ...
                <div class="card-header">
                    <h4>Edit & Update Post
                        <a href="{{ route('peace.view')}}" class="btn btn-danger float-end">BACK</a>
                    </h4>
                </div>
                <div class="card-body">

                    <form action="{{ route('update.peace',$peace->id) }}" method="POST">
                        @csrf
    

                        <div class="form-group mb-3">
                            <label for="">Title</label>
                            <input type="text" name="title" value="{{$peace->title}}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for=""> Content</label>
                         <textarea id="summernote" type="text"  class="form-control" name="body"cols="150" rows="35">{{$peace->body}}"</textarea>
                        </div>
                        <div class="form-group mb-3">
