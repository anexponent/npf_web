            ...
            <div class="container-fluid">
                ...
                <!-- Left col -->
                    <section class="col-lg-12">
                        ...
                        <div class="card">
            <form method ="post" action="{{url('store.security')}}" class="security_form">
        @csrf
                        
  <div class="mb-3">
    <label for="title" class="form-label">Title</label>
    <input type="text" class="form-control" name="title" id="title" aria-describedby="titleHelp" placeholder="Security Tips">
  </div>
  <div class="col-sm-10">
