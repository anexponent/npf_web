                ...
                <section class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <form method="post" action="{{route('update.news')}}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id" value="{{$newspos->id}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="news_category_id" class="form-select"
                                        ...
                                        <option value="{{$cat->id}}"
                                            {{$cat->id==$newspos->news_category_id ? 'selected' : ''}}>
                                            {{$cat->news_category}}</option>
                                        @endforeach
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="news_title" class="form-control" value="{{$newspos->news_title}}"
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">News Description
                                </label>
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="news_content">
                            {{$newspos->news_content}}
                                </textarea>
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="news_image" class="form-control" type="file" id="pro_image">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg"
                                        src="{{(!empty($newspos->igp_image))? url( $newspos->igp_image):url('upload/no_image.png')}}"
                                        alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
