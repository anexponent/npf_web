...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="row">
                ...
                <section class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <form method="post" action="{{route('store.missing')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input name="height" class="form-control" type="number" step="0.01" id="example-text-input">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-5">
                            <input name="state" class="form-control" type="text" id="example-text-input">

                                @error('state')
                                <span class="text-danger"> {{ $message }} </span>
                                @enderror
                            </div>
                            <label for="example-text-input" class="col-sm-1 col-form-label">Local Government</label>
                            <div class="col-sm-5">
                                <input name="lga" class="form-control" type="text" id="example-text-input">
        ...
        <!-- end row -->
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-1 col-form-label">Location Last Seen </label>
                                <div class="col-sm-5">
                                    <input name="locationLastSeen" class="form-control" type="text" id="example-text-input">

                                    @error('locationLastSeen')
                                    <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input name="complexonColor" class="form-control" type="text"
                                        id="example-text-input">

                                    @error('complexonColor')
                                    <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input name="gender" class="form-control" type="text" id="example-text-input">
