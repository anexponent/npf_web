                        ...
                        <table id=" datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('edit.wanted',$item->id)}}" class="btn btn-info sm"
                                            title="Edit Data"> <i class="fas fa-edit"></i> </a>

                                        <a href="{{route('delete.wanted',$item->id)}}" class="btn btn-danger sm"
                                ...
                                <span>
                                    {{$wanted_person->links('pagination::bootstrap-5') }}
                                </span>
                        </table>
