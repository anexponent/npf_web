    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h2 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Department of {{ $department->department }}</h2>
        ...
        <div class="row">
          <div class="col-12 col-lg-9">
            <div class="tm-description paragraph">
              <h3 class="tm-title">About the Department of {{ $department->department }}</h3>
               <div class="div"> {!! $department->description !!}  </div>
            </div>
          </div>
          <div class="col-12  col-lg-3 mx-auto ">
            <div class="profile ">
              <div class="tm-img  ">
                ...
                <img class=" img-fluid " loading="lazy" src="{{ asset('build/uploads/department/no-image.jpg')}}" alt="Team Member">
                    @else
                <img class=" img-fluid " loading="lazy" src="{{ asset($department->image)}}" alt="Team Member">
                    @endif
              </div>
              <div class="tm-details">
                <h6 class="name">{{ $department->rank }} {{ $department->dig_name }}</h6><span class="role">Department of {{ $department->department }}  </span>
              </div>
              <div class="tm-social">
