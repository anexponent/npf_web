            ...
            <div class="page-header-ui-content position-relative">
                <div class="container px-5 text-center">
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8">
                            <h1 class="page-header-ui-title mb-3">Department of {{ $department->department }}</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card card-team">
                                <div class="card-body">
                                    ...
                                    @if ($department->image == null)
                                        ...
                                        @endif
                                    />
                                    <div class="card-team-name">{{ $department->rank }} {{ $department->dig_name }}</div>
                                    <div class="card-team-position mb-3">Deputy Inspector General of Police</div>
                                </div>
                                <div class="card-footer text-center">
                                    <div class="card-team-position mb-4">Department of {{ $department->department }}</div>
