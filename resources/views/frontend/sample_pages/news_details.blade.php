      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-10 mx-auto">
            ...
            <div class="post-img-wrapper post-featured-area"><img class="featured-img" loading="lazy" src="{{asset('build/frontend/assets/images/blog/post-images/featured-img.jpg')}}" alt="Featured Image"></div>
          </div>
          <div class="col-12 col-lg-9 mx-auto">
            <div class="post-main-area">
              ...
              <div class="post-content">
                ...
                <div class="post-img-wrapper"><img loading="lazy" src="{{asset('build/frontend/assets/images/blog/post-images/post-img.jpg')}}" alt="post image"></div>
                <p class="post-text">
                   Lorem  
                  elit Impedit explicabo quis veritatis, 
                  sed ipsam reprehenderit aliquam magni perferendis 
                ...
                <p class="post-text">
                  ...
                  nam eum unde tenetur nisi temporibus veniam cumque nemo! 
                  <img class="float-end-direction " loading="lazy" src="{{asset('build/frontend/assets/images/blog/post-images/2.jpg')}}" alt="post image">Deleniti quas, ea fuga vel, quis officiis laborum quaerat numquam possimus 
                  qui alias fugiat aliquam eius soluta beatae? 
                  Deleniti quas, ea fuga vel, quis officiis laborum quaerat numquam possimus 
                  qui alias fugiat aliquam eius soluta beatae?
                  nobis maiores inventore, harum pariatur, 
              ...
              <div class="author-profile panel">
                ...
                <div class="author-info">
                  <div class="author-avatar"><a class="author-link" href="#"><img class="avatar-img" loading="lazy" src="{{asset('build/frontend/assets/images/blog/avatars/1.jpg')}}" alt="author avatar"></a></div>
                ...
                <div class="row">
                  <div class="col-12 col-sm-6 mb-3">
                    <div class="prev-post"><a class="other-post-link" href="#0">
                        <div class="other-post-img" title="Previous Post"><img class="img-fluid" loading="lazy" src="{{asset('build/frontend/assets/images/blog/post-images/1.jpg')}}" alt="other posts Image"><i class="bi bi-chevron-left icon "></i>
                        </div>
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="next-post"><a class="other-post-link" href="#0">
                        <div class="other-post-img" title="Next Post"><img class="img-fluid" loading="lazy" src="{{asset('build/frontend/assets/images/blog/post-images/2.jpg')}}" alt="other posts Image"><i class="bi bi-chevron-right icon "></i>
                        </div>
              ...
              <div class="col-12 col-lg-8">
                ...
                <div class="comments-area panel">
                  ...
                  <div class="comment-wrapper ">
                    <div class="author-avatar"><a class="comment-author-link" href="#"><img class="author-avatar-img" loading="lazy" src="{{asset('build/frontend/assets/images/blog/avatars/2.jpg')}}" alt="author avatar"></a></div>
                  ...
                  <div class="comment-wrapper comment-reply ">
                    <div class="author-avatar"><a class="comment-author-link" href="#"><img class="author-avatar-img" loading="lazy" src="{{asset('build/frontend/assets/images/blog/avatars/1.jpg')}}" alt="author avatar"></a></div>
                    <div class="comment-body">
                  ...
                  <div class="comment-wrapper ">
                    <div class="author-avatar"><a class="comment-author-link" href="#"><img class="author-avatar-img" loading="lazy" src="{{asset('build/frontend/assets/images/blog/avatars/3.jpg')}}" alt="author avatar"></a></div>
                    <div class="comment-body">
                  ...
                  <div class="comment-wrapper comment-reply ">
                    <div class="author-avatar"><a class="comment-author-link" href="#"><img class="author-avatar-img" loading="lazy" src="{{asset('build/frontend/assets/images/blog/avatars/4.jpg')}}" alt="author avatar"></a></div>
                    <div class="comment-body">
