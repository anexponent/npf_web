    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Directorate of Peace Keeping
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
            <div class="tm-description">
              <h3 class="tm-title">Directorate of Peace Keeping

Operations</h3>
              
              @foreach ($peace as $peace)
             <div class="div"> {!! $peace->body !!}</div>
              @endforeach
