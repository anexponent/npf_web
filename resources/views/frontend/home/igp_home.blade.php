    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">{{$aboutpage->speech_heading}}</h1>
        ...
        <div class="row">
          <div class="col-12 col-lg-9">
            <div class="tm-description">
              <h3 class="tm-title">{{ $aboutpage->title}} </h3>
              <div class="tm-text">
          ...
          <div class="col-12  col-lg-3 mx-auto ">
            <div class="profile ">
              <div class="tm-img  "><img class=" img-fluid " loading="lazy" src="{{ asset($aboutpage->igp_image) }}" alt="Team Member"></div>
              <div class="tm-details">
                <h6 class="name"> Olukayode Adeolu Egbetokun, Ph.D, NPM</h6><span class="role">Inspector General of Police    </span>
              </div>
              <div class="tm-social">
