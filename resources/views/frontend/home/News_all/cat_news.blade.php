    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">{{$categoryName->news_category}}</h1>
                ...
                <div class="col-12 ">
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="How litespeed technology works to speed up your site ">
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="{{route('news.details',$item->id)}}"> <i class="bi bi-bookmark icon"></i>hosting</a><a class="info post-author" href="#"> <i class=" bi bi-person icon"></i>{{$item->created_at}} </a></div>
                      <div class="post-text"><a class="post-link" href="{{route('news.details',$item->id)}}">


                        <h3 class="post-title"> {{ Str::limit($item->news_title, 50)}} </h3></a>
                        <!--<p class="post-excerpt">{!! Str::limit($item->news_content, 200) !!}  </p>--><a class="read-more" href="{{route('news.details',$item->id)}}" title="How litespeed technology works to speed up your site ">read more<i class="bi bi-arrow-right icon "></i></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12">
                    <nav aria-label="Page navigation example">
                        ...
                        <ul class="pagination pagination-blog justify-content-center">
                            @if($CatNewsPost->total() > $CatNewsPost->perPage())
                            {{ $CatNewsPost->links() }}
                            @endif
