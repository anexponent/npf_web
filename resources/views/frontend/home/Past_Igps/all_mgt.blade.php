    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">The Past Inspector Generals of Police</h1>
    ...
    <!-- Start inner Page hero-->
      ...
      <div class="container">
        ...
        <div class="container-fluid">
          <div class="row">
            @foreach($pstigpteamfront as $item)
            <!--first Team Member-->
            <div class="col-12 col-md-6  col-lg-3 mx-md-auto ">
              <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="tm-details"><a class="tm-link" href="#">
                    <h2 class="tm-name">{{ $item->full_name }}</h2></a><span class="tm-role">{{ $item->designation }}</span><br><span class="tm-role">{{ $item->duration_service }}</span></div>
              </div>
            </div>
            @endforeach
             <div class="col-12">
                <nav aria-label="Page navigation example">
                    ...
                    <ul class="pagination pagination-blog justify-content-center">
                        @if($pstigpteamfront->total() > $pstigpteamfront->perPage())
                        {{ $pstigpteamfront->links() }}
                        @endif
