    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">History of the Nigeria Police Force</h1>
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
            <div class="tm-description">
              <h3 class="tm-title">History of the Nigeria Police Force</h3>
              
              @foreach ($history as $item)
             <div class="div"> {!! $item->body !!}</div>
              @endforeach
