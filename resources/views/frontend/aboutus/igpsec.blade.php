    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">IGP Secreatariat</h1>
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
            <div class="tm-description">
              <h3 class="tm-title">IGP Secreatariat</h3>
              
              @foreach ($igpsec as $igpsec)
             <div class="div"> {!! $igpsec->body !!}</div>
              @endforeach</div>
