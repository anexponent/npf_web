    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">{{ $UnitsData->type_of_unit }}</h1>
        </div>
      </div>
    </section>
    <!-- End inner Page hero-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
            <div class="tm-description">
              <h3 class="tm-title">About {{ $UnitsData->type_of_unit }}</h3>
              <p class="tm-text">{!! $UnitsData->content !!}</p>
